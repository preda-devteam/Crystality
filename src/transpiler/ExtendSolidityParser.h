...
class  ExtendSolidityParser : public antlr4::Parser {
public:
  enum {
  ...
  explicit ExtendSolidityParser(antlr4::TokenStream *input);

  ExtendSolidityParser(antlr4::TokenStream *input, const antlr4::atn::ParserATNSimulatorOptions &options);

  ~ExtendSolidityParser() override;
  ...
  public:
    ExtendSolidityParser::ExpressionContext *firstExpression = nullptr;
    ExtendSolidityParser::ExpressionContext *secondExpression = nullptr;
    ExtendSolidityParser::ExpressionContext *thirdExpression = nullptr;
