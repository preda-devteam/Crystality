...
void ExtendSolidityTreeWalker::walk(antlr4::tree::ParseTreeListener* listener, antlr4::tree::ParseTree* t) const
{
...
ExtendSolidityTreeWalker::~ExtendSolidityTreeWalker()
{
